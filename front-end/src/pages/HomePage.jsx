            ...
            <div className="bg-white p-8 rounded-lg shadow-[0px_0px_12px_11px_rgba(0,0,0,0.05)]">
              ...
              <div className="mt-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 text-sm ">
                  <div
                    className="border border-gray-300 p-3 rounded-lg bg-gradient-to-r from-blue-500/[0.1] via-purple-500/[0.1] to-pink-500/[0.1]  hover:bg-blue-500 hover:text-white transition duration-300 text-gray-800"
                    onClick={handleClick}
                  >
                    Job Postings
                  </div>
