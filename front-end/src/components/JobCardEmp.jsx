...
const JobCardEmp = ({
  ...
  return (
    <Fragment>
      <div className="flex flex-row bg-white rounded-lg shadow-md p-4 mb-4 gap-4">
        ...
        <div className="flex flex-col w-full">
          <div className="flex gap-2 justify-between">
            <h3 className="md:text-xl font-bold text-gray-800 ">{jobTitle}</h3>
            <div className="flex">
              <div>
                <Button
                  size="sm"
          ...
          <div className="flex items-center justify-between">
            ...
            <p className="text-gray-600 text-xs">
              Posted on: <span className="text-blue-500">{fullDate}</span>
            </p>
          </div>
          <div className="flex justify-between my-1 flex-col md:flex-row">
